...
Original file is located at
    https://colab.research.google.com/drive/1IGGyk14jkF336G31TlN7v_Iy63CDoA-Z
...
Tommaso Framba (tframba@ucsc.edu)

Chris Toukmaji (ctoukmaj@ucsc.edu)
...
score, acc = model.evaluate(test_set, batch_size = 32)
